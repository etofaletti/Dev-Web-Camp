<fieldset class="formulario__fieldset">
    ...
    <div class="formulario__campo">
        ...
        <textarea name="descripcion" id="descripcion" class="formulario__input" placeholder="Descripción Evento" rows="8"><?php echo $evento->descripcion; ?></textarea>
    </div>
...
<fieldset class="formulario__fieldset">
    ...
    <div class="formulario__campo">
        ...
        <input type="number" min="1" name="disponibles" id="disponibles" class="formulario__input" placeholder="Ej. 20" value="<?php echo $evento->disponibles; ?>">
    </div>
</fieldset>